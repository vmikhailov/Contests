    ...
    public static class KPrimesTests
    {
        ...
        public static void test1()
        {
            ...
            testing(
                ...
                Array2String([500, 520, 552, 567, 588, 592, 594]));
            ...
            testing(
                ...
                Array2String([8, 12, 18, 20, 27, 28, 30, 42, 44, 45, 50, 52, 63, 66, 68, 70, 75, 76, 78, 92, 98, 99]));

            testing(
                Array2String(KPrimes.CountKprimes(5, 1000, 1100)),
                Array2String([1020, 1026, 1032, 1044, 1050, 1053, 1064, 1072, 1092, 1100]));
        }
