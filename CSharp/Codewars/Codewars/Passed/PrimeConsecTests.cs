...
namespace Codewars.Codewars.Passed
{
    ...
    public static class PrimeConsecTests
    {
        ...
        public static void test1()
        {
            ...
            testing(5, [10116, 10108, 10092, 10104, 10100, 10096, 10088], 6);
        
            testing(4, [10005, 10030, 10026, 10008, 10016, 10028, 10004], 3);
            testing(
                2,
                [
                ...
                2);
            testing(6, [10098], 0);
            testing(6, [10176, 10164], 0);
      
            testing(5, [10188, 10192, 10212, 10184, 10200, 10208], 1);
            testing(4, [10175, 10185, 10180, 10197], 3);
        }
    }
}